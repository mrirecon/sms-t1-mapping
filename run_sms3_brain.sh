...
for j in ${scans[@]} ; do
        ...
        ./reco.sh -m$sms -R$lambda -o$overgrid ${prefix}-TI.coo ${prefix}-traj.coo ${prefix}-data.coo ${prefix}-sms3-brain-reco-${reg}.coo | tee -a $prefix.log
        ./post.sh -R$TR -r$res ${prefix}-sms3-brain-reco-${reg}.coo ${prefix}-sms3-brain-${reg}-t1map.coo
