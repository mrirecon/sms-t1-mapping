...
bart transpose 2 13 $dir/masks/vol_1-a-sms5_mask tmp_mask
bart resize -c 0 256 1 256 $dir1/vol_1-a-sms5-brain-reco-001.coo $dir1/vol_1-a-sms5-brain-reco-001_256
...
do
        start=$((i))
        fin=$((i + 1))
        bart slice 13 $i $dir1/vol_1-a-sms5-brain-reco-001_256 tmp_maps
