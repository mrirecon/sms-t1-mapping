...
bart fmac $dir1/vol_1-inter3-center-brain-001-t1map.coo tmp_mask_center tmp
bart transpose 0 1 tmp tmp1
bart flip $(bart bitmask 0) tmp1 tmp
bart flip $(bart bitmask 1) tmp T1map_01

# sms-gaal results:
bart fmac $dir1/vol_1-sms3-gaal-center-brain-001-t1map.coo tmp_mask_center tmp
bart transpose 0 1 tmp tmp1
bart flip $(bart bitmask 0) tmp1 tmp
bart flip $(bart bitmask 1) tmp T1map_02

# sms-ga results:
bart extract 13 1 2 $dir1/vol_1-a-sms3-brain-001-t1map.coo tmp0
...
bart join 1 T1map_comp tmp_rela_diff_comp Fig04A
